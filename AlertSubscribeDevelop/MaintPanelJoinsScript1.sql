SELECT PROG.ID, PROG.NAME, PROG.DESCRIPTION, 
  ...
  CLT_CONF.CHAN_EMAIL_PRIORITY, 
  CLT_CONF.CHAN_IVR_PRIORITY,
  CLT_CONF.CHAN_SMS_PRIORITY, 
  CLT_CONF.CHAN_SECURE_PRIORITY, 
  CLT_CONF.CHAN_CLIENT_SECURE_PRIORITY,
  CLT_CONF.CHAN_DEFAULT, CLT_CONF.REQUIRED, CLT_CONF.MANDATORY
  FROM
       PROGRAM AS PROG 
